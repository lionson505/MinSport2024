...
function NationalTeams() {
  ...
  // Get the moduleId for national teams from the fetched modules
  const nationalTeamsModule = modules.find(m => m.name === 'National Teams');
  const moduleId = nationalTeamsModule?.id;
