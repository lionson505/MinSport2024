...
const Sidebar = ({ onLinkClick }) => {
  ...
  const sidebarLinks = [
    { title: "Dashboard", path: '/dashboard', icon: LayoutGrid, moduleId: MODULE_IDS.DASHBOARD },
    { title: "National Teams", path: '/national-teams', icon: Flag, moduleId: MODULE_IDS.NATIONAL_TEAMS },
    ...
    { title: "Sports tourism", path: "/sports-tourism", icon: Plane, moduleId: MODULE_IDS.SPORTS_TOURISM },
    { title: "Documents", path: "/documents", icon: FileText, moduleId: MODULE_IDS.DOCUMENTS },
    { title: "Contracts", path: "/contracts", icon: Briefcase, moduleId: MODULE_IDS.CONTRACTS },
    { title: "Appointments", path: "/appointments", icon: Calendar, moduleId: MODULE_IDS.APPOINTMENTS },
    { title: "Appointments-Ps", path: "/appointments-ps", icon: Calendar, moduleId: MODULE_IDS.APPOINTMEN_PS },
    { title: "Appointments-Ministers", path: "/appointments-ministers", icon: Calendar, moduleId: MODULE_IDS.APPOINTMENT_MINISTER },
    { title: "Employee", path: "/employee", icon: Users, moduleId: MODULE_IDS.EMPLOYEE },
    { title: "Users", path: "/users", icon: UsersRound, moduleId: MODULE_IDS.USERS },
    { title: "Partners", path: "/partners", icon: Users, moduleId: MODULE_IDS.PARTNER },
    ...
    { title: "Transfers", path: "/player-transfer-report", icon: UserPlus, moduleId: MODULE_IDS.TRANSFERS },
    { title: "Match", path: "/match-operator", icon: Timer, moduleId: MODULE_IDS.MATCH }
  ];

  useEffect(() => {
    const fetchAuthorizedLinks = async () => {
      const authorizedLinksPromises = sidebarLinks.map(async (link) => {
        const hasAccess = await hasModuleAccess(link.moduleId);
        return hasAccess ? link : null;
      });

      const resolvedLinks = await Promise.all(authorizedLinksPromises);
      setAuthorizedLinks(resolvedLinks.filter(Boolean));
    };
